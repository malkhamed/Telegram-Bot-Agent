...
$Check_filde = $connect->query("SHOW COLUMNS FROM invoice LIKE 'agent_id'");
if (mysqli_num_rows($Check_filde) != 1) {
    $connect->query("ALTER TABLE invoice ADD agent_id VARCHAR(200)");
    echo "The agent_id field was added ✅";
}
